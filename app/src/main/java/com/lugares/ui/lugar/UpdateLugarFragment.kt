...
class UpdateLugarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //Para ininializar y activar boton de play... si hay una ruta
    ...
    private fun realizarLlamada() {
        ...
        if (recurso.isNotEmpty()){
            ...
            if (requireActivity().checkSelfPermission(Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
                //Si no se ha otorgado el permiso de hacer llamadas... que se pida el permiso
                requireActivity().requestPermissions(arrayOf(Manifest.permission.CALL_PHONE),105)
            }else{ //Si se tiene permiso realice la llamada
    ...
    private fun updateLugar() {
        ...
        if(nombre.isNotEmpty()){ //Crea el lugar
